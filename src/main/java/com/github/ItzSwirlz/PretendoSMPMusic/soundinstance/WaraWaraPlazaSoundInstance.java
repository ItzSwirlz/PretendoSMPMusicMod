...
public class WaraWaraPlazaSoundInstance extends MovingSoundInstance {
    public WaraWaraPlazaSoundInstance() {
        // Initialize sounds here
        super(SoundEvent.createVariableRangeEvent(new Identifier("pretendosmpmusic:music.warawaraplaza")), SoundCategory.AMBIENT, SoundInstance.createRandom());
    }
